                      ...
                      <div className="flex justify-between items-center mb-8">
                        <div>
                          <div className="inline-flex items-center gap-2 rounded-full border border-cyan-500/40 bg-cyan-500/10 px-3 py-1 text-xs font-semibold text-cyan-300">
                            ...
                            <span>CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> &amp; CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> Lite Documentation</span>
                          </div>
                          ...
                          <p className="mt-2 text-sm md:text-base text-slate-300 max-w-2xl">
                            This page describes how CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span>&apos;s realtime translator and CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> Lite gateway work together:
                        ...
                        <div className="space-y-6">
                          <section className="rounded-2xl border border-slate-700/70 bg-slate-900/70 p-5 shadow-xl shadow-cyan-900/40">
                            <h2 className="text-lg font-semibold text-cyan-300 mb-3">
                              1. End-to-End Streaming Flow (Client ⇄ CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> Lite ⇄ Providers)
                            </h2>
                            <p className="text-xs md:text-sm text-slate-300 mb-3">
                              CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> desktop client and browser extension stream raw audio to a local Electron core, which
                              bridges to CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> Lite running in the cloud. CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> Lite then orchestrates provider calls
...
Electron Core
  ↓  /api/stt/stream (CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> Lite)
  ↓  Provider STT (Google/Azure) → partial + final transcripts
  ↓  /api/translate (CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> Lite with glossary & caching)
...
Typical one-way latency: 200–400ms (network + provider + local render).`}
                          ...
                          <section className="rounded-2xl border border-slate-700/70 bg-slate-900/70 p-5 shadow-xl shadow-cyan-900/40">
                            ...
                            <p className="text-xs md:text-sm text-slate-300 mb-3">
                              For text-to-speech, CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> uses a hybrid strategy: a local ONNX model (Piper) for instant
...
/api/tts/speak-stream(engine, language, text)
  ...
  ↓  CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> Lite forwards chunks to client
  ↓  audio watermark injected before output`}
                                </pre>
                                <p className="mt-2 text-[10px] text-slate-400">
                                  The gateway chooses the engine based on plan, language, and health checks. If a cloud
                                  provider fails, CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> Lite can fall back or temporarily rely more on ONNX voices.
                                </p>
                              </div>
                            </div>
                          </section>
                          ...
                          <section className="rounded-2xl border border-slate-700/70 bg-slate-900/70 p-5 shadow-xl shadow-cyan-900/40">
                            ...
                            <p className="text-xs md:text-sm text-slate-300 mb-3">
                              To protect generated audio, CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> inserts a lightweight PCM watermark before it reaches the
...
{`for each PCM16 frame:
  ...
  output[i] = clamp16(base + mark)`}
                          ...
                          <section className="rounded-2xl border border-slate-700/70 bg-slate-900/70 p-5 shadow-xl shadow-cyan-900/40">
                            ...
                            <p className="text-xs md:text-sm text-slate-300 mb-3">
                              CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> Lite is also exposed as a standalone API product via RapidAPI and blockchain-based
...
CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> Lite
  ↓  validates token → routes to providers
  ↓  streams audio back to consumer`}
                              </pre>
                              <p className="mt-2 text-[10px] text-slate-400">
                                  This pattern allows usage-based pricing and on-chain revenue splits, while CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> Lite
                        ...
                        <aside className="space-y-4">
                          <div className="rounded-2xl border border-cyan-500/50 bg-slate-900/80 p-4 shadow-xl shadow-cyan-900/50">
                            <h3 className="text-sm font-semibold text-cyan-300 mb-2">CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> Runtime Snapshot</h3>
                          ...
                          <div className="rounded-2xl border border-slate-700 bg-slate-900/80 p-4">
                            ...
                            <ul className="text-[11px] text-slate-300 space-y-1.5">
                              <li>
                                <span className="font-semibold text-cyan-300">CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> Desktop:</span> quickest way to use
                                realtime translation in meetings.
                              </li>
                              <li>
                                <span className="font-semibold text-cyan-300">CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> Lite API:</span> when you need
