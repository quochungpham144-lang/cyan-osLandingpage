          ...
          <div className="space-y-5 text-sm leading-relaxed">
            <div>
              ...
              <p className="mt-1 text-gray-300">
                By accessing and using the CYAN OS<span className="tm-symbol">™</span> utility (hereinafter referred to as the &quot;Service&quot;), you
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                CYAN OS<span className="tm-symbol">™</span> provides an ultra-low latency, real-time AI translation solution, utilizing third-party API
            ...
            <div>
              ...
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
                <li>
                  ...
                  consent from the voice owner before using the cloning feature. CYAN OS<span className="tm-symbol">™</span> assumes no liability for
                  unauthorized impersonation.
                </li>
                <li>
                  Prohibitions: Using CYAN OS<span className="tm-symbol">™</span> to create fraudulent content (Deepfakes), hate speech, or content that
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                CYAN OS<span className="tm-symbol">™</span> does not guarantee 100% accuracy of translated content due to the inherent nature of AI technology.
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                Subject to your compliance with these Terms, CYAN OS<span className="tm-symbol">™</span> grants you a limited, non-exclusive, non-transferable,
                and revocable license to access and use the Service for lawful business or personal purposes.
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
                <li>Ownership: All rights, title, and interest in and to the Service, including software, models, and branding, remain with CYAN OS<span className="tm-symbol">™</span> and its licensors.</li>
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                CYAN OS<span className="tm-symbol">™</span> aims to provide a stable, high-availability translation service but does not guarantee uninterrupted
                or error-free operation.
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
                <li>
                  11.1. Modification of Fees: CYAN OS<span className="tm-symbol">™</span> reserves the right to change our subscription plans or adjust
            ...
            <div>
              ...
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
                <li>Exclusions: CYAN OS<span className="tm-symbol">™</span> disclaims any implied warranties of merchantability, fitness for a particular purpose, and non-infringement.</li>
                <li>Liability Cap: To the extent permitted by law, CYAN OS<span className="tm-symbol">™</span>&apos;s aggregate liability arising out of or relating to the Service will not exceed the amounts you have paid for the Service in the six (6) months preceding the event giving rise to the claim.</li>
                <li>Indirect Damages: CYAN OS<span className="tm-symbol">™</span> is not liable for any indirect, incidental, special, consequential, or punitive damages, including loss of profits or data.</li>
                <li>
                  12.1. Third-Party Dependency Disclaimer: The Service relies on third-party Application Programming
                  Interfaces (APIs) including, but not limited to, ElevenLabs, Microsoft Azure, and Google Cloud. CYAN OS<span className="tm-symbol">™</span>
            ...
            <div>
              ...
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
                <li>
                  13.1. Exclusive Forum: You and CYAN OS<span className="tm-symbol">™</span> agree that all disputes, claims, controversies, or causes of
                ...
                <li>
                  13.3. Injunctive and Equitable Relief: Notwithstanding any other provision, CYAN OS<span className="tm-symbol">™</span> may seek
