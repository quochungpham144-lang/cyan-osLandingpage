      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
            We've solved the hardest problems in real-time translation so you
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-4 lg:gap-6 max-w-6xl mx-auto">
          ...
          <div className="md:col-span-2 md:row-span-1 group relative p-8 rounded-2xl bg-white/90 dark:bg-slate-900/80 backdrop-blur-md border border-gray-200/80 dark:border-slate-800/80 hover:border-cyan-500/50 transition-all duration-500 shadow-sm hover:shadow-xs hover:shadow-cyan-500/10 overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center gap-10 h-full">
              <div className="flex-1">
                ...
                <h3 className="text-xl sm:text-2xl font-bold mb-3 text-gray-900 dark:text-white tracking-tight">
                  Ultra-Low Latency
                </h3>
                <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 leading-relaxed max-w-md">
                  Experience real-time conversations with latency in the
                  200–400ms range. Engineered for natural, fluid communication
                  without the typical AI lag.
                </p>
              </div>
              ...
              <div className="flex-shrink-0 w-full lg:w-auto flex items-center justify-center py-4 sm:py-0">
                <div className="relative w-36 h-36 flex items-center justify-center">
                  ...
                  <div
                    className="absolute inset-0 rounded-full border-t-2 border-cyan-500/30 animate-spin"
          ...
          <div className="md:col-span-1 md:row-span-2 group relative p-8 rounded-2xl bg-gradient-to-br from-gray-900 via-slate-900 to-black dark:from-slate-900 dark:via-slate-800/80 dark:to-slate-900 border border-cyan-500/40 text-white overflow-hidden shadow-xs shadow-cyan-500/10 transition-transform duration-500">
            ...
            <div className="relative z-10 flex flex-col h-full">
              <div className="mb-8 inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-cyan-500/20 backdrop-blur-md text-cyan-400 border border-cyan-500/30 shadow-sm">
                <Mic className="w-7 h-7" />
              </div>

              <h3 className="text-xl sm:text-2xl font-bold mb-3 bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-300 tracking-tight">
                Human-Grade Voice Output
              </h3>
              <p className="text-sm sm:text-base text-gray-400 leading-relaxed mb-8">
                Our AI doesn't just translate words; it preserves emotion, tone,
                and personality. The result is a voice that sounds genuinely
                human, maintaining the speaker's intent and warmth in every
                conversation.
              </p>
          ...
          <div className="md:col-span-2 md:row-span-1 group relative p-8 rounded-2xl bg-white/90 dark:bg-slate-900/80 backdrop-blur-md border border-gray-200/80 dark:border-slate-800/80 hover:border-blue-500/50 transition-all duration-500 shadow-sm hover:shadow-xs hover:shadow-blue-500/10 overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center gap-10 h-full">
              <div className="flex-1">
                ...
                <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 leading-relaxed max-w-md">
                  Works effortlessly with Zoom, Teams, Meet, and all major
                  communication platforms. One click to activate, zero setup
                  required.
                </p>
              </div>
              ...
              <div className="flex-shrink-0 w-full lg:w-auto grid grid-cols-3 gap-3">
                {[
                  ...
                  {
                    name: "Teams",
                    logo: "https://upload.wikimedia.org/wikipedia/commons/5/50/Microsoft_Teams.png",
                  },
                  {
                    name: "Meet",
                    logo: "https://cloud.gmelius.com/public/logos/google/Google_Meet_Logo.svg",
                  },
                  {
                    name: "Webex",
                    logo: "https://images.seeklogo.com/logo-png/37/2/cisco-webex-meeting-logo-png_seeklogo-372182.png",
                  },
                  {
                    name: "Slack",
                  ...
                  {
                    name: "Discord",
                    logo: "https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/discord-round-color-icon.png",
                  },
                ].map((platform, i) => (
                  <div
                    key={platform.name}
                    className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl bg-white dark:bg-slate-900/80 border border-gray-200/80 dark:border-slate-800/80 flex flex-col items-center justify-center gap-2 shadow-sm group-hover:scale-105 transition-transform duration-300"
                      ...
                      <img
                        ...
                        onError={(e) => {
                          ...
                          if (parent) {
                            ...
                            fallback.className =
                              "w-full h-full flex items-center justify-center bg-gray-100 dark:bg-slate-700 rounded-lg text-[10px] font-bold text-gray-400";
