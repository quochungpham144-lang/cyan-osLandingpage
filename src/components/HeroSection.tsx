...
export const HeroSection = memo(
  ({ setView, openPricingSection, trackEvent, setRef }: Props) => {
      ...
      >
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col items-center justify-center gap-4 mb-8">
            <div className="text-xs sm:text-sm font-mono font-semibold uppercase tracking-[0.3em] text-cyan-600 dark:text-cyan-400">
              Featured In
            </div>
          ...
          <div className="mt-2">
            ...
            <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 mb-10 max-w-2xl mx-auto leading-relaxed">
              Break language barriers in real-time meetings with impeccable
              clarity and natural voice.
            </p>
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-4 justify-center items-center px-4 max-w-4xl mx-auto">
              <a
                ...
                onClick={(e) => {
                  ...
                  trackEvent("cta_click", {
                    button_name: "download_view",
                    location: "hero_section",
                    destination: "download_view",
                  });
                  setView("download");
                }}
                className="w-full sm:w-auto bg-gradient-to-r from-cyan-600 to-blue-600 text-white px-6 py-3.5 rounded-xl font-bold text-sm sm:text-base hover:from-cyan-700 hover:to-blue-700 transition-all duration-300 hover:scale-[1.02] shadow-md hover:shadow-cyan-500/25 text-center"
              >
                Download CYAN OS
              </a>
              ...
              <a
                ...
                className="w-full sm:w-auto bg-gradient-to-r from-emerald-500 to-teal-600 text-white px-6 py-3.5 rounded-xl font-bold text-sm sm:text-base hover:from-emerald-600 hover:to-teal-700 transition-all duration-300 hover:scale-[1.02] shadow-md hover:shadow-emerald-500/25 text-center"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-auto bg-white/80 dark:bg-slate-900/80 text-gray-900 dark:text-white px-6 py-3.5 rounded-xl font-bold text-sm sm:text-base border border-gray-200/80 dark:border-slate-800/80 hover:bg-gray-50 dark:hover:bg-slate-800 transition-all duration-300 hover:scale-[1.02] backdrop-blur-sm shadow-sm text-center"
              >
                API Docs
              </a>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mt-16 max-w-5xl mx-auto px-4">
              {[
                ...
                <div
                  key={idx}
                  className={`bg-white/90 dark:bg-slate-900/80 backdrop-blur-xl border border-gray-200/80 dark:border-slate-800/80 rounded-2xl p-6 md:p-8 shadow-sm hover:shadow-xs hover:shadow-cyan-500/10 hover:-translate-y-1 transition-all duration-300 group`}
                >
                  <div className="w-12 h-12 md:w-14 md:h-14 mx-auto rounded-xl flex items-center justify-center mb-4 md:mb-6 bg-gray-50 dark:bg-slate-800 shadow-sm group-hover:scale-110 transition-transform">
                    <stat.icon
                      className={`w-6 h-6 md:w-7 md:h-7 ${stat.color}`}
                    />
                  </div>
                  <div className="text-3xl font-extrabold mb-2 text-gray-900 dark:text-white tracking-tight">
                    {stat.label}
                  </div>
