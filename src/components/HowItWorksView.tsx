      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        ...
        <main className="bg-gray-900/80 border border-gray-800 rounded-2xl shadow-xl px-6 py-6 md:px-8 md:py-8">
          <div className="flex items-start justify-between gap-4 border-b border-gray-800 pb-4 mb-6">
            <div>
              <div className="text-base md:text-lg font-semibold text-white">HOW CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> REAL-TIME TRANSLATOR WORKS</div>
          ...
          <div className="space-y-5 text-sm leading-relaxed">
            <div>
              ...
              <p className="mt-1 text-gray-300">
                CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> is designed to sit next to your meetings, calls, and webinars as a low-latency translation layer.
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                The CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> desktop client captures audio in real time:
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                Inside the backend, CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> coordinates multiple AI services:
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                After translation, CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> turns the text back into speech and streams it:
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                For Executive Pro users, CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> supports customized voice cloning:
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> was built with privacy-first constraints:
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> is optimized for real-world, high-stakes communication where human interpreters are expensive or unavailable:
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                For engineering teams integrating CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> into production workflows, it is important to treat the numbers on the landing page as realistic targets, not hard SLAs:
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
              ...
              <p className="mt-2 text-gray-300">
                When building on CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> or the public API, we recommend instrumenting your own latency and error metrics so you can tune timeouts, backoff strategies, and user experience for your specific region and infrastructure.
              </p>
            </div>
          </div>
        </main>
