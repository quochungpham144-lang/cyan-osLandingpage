        ...
        <main className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-32">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-cyan-600 dark:text-cyan-400 font-bold mb-6">
              ...
              <div className="space-y-4 max-w-sm text-gray-700 dark:text-gray-300 text-sm md:text-base leading-relaxed px-4">
                <p>
                  Product Management Lead for Blockchain & AI Infrastructure
                </p>
                ...
                <p className="text-gray-500 dark:text-gray-400 text-xs font-medium uppercase tracking-widest pt-2">
                  Hanoi, Vietnam
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="space-y-4 max-w-sm text-gray-700 dark:text-gray-300 text-sm md:text-base leading-relaxed px-4">
                <p>
                  Data science and machine learning specialist | Computer
                  Science at KIET and Data Science at IIT Guwahati ('28) | Leads
                  model optimization, pipeline engineering, and all technical
                  execution.
                </p>
                <div className="flex justify-center pt-4">
                  <a
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="space-y-4 max-w-sm text-gray-700 dark:text-gray-300 text-sm md:text-base leading-relaxed px-4">
                <p>
                  Web3 Marketer | AI x Crypto | GTM & Narrative Leadership ||
          ...
          <div className="bg-white/50 dark:bg-gray-900/50 border border-cyan-200 dark:border-gray-800 rounded-3xl p-8 md:p-12 max-w-4xl mx-auto shadow-xs">
            <div className="text-xs font-bold text-cyan-600 dark:text-cyan-400 uppercase tracking-widest mb-4">
              Our Commitment
            </div>
            <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed italic">
              "At Electron Cyan, we aren't just building a translator. We're
              building a bridge for human potential, ensuring that language is
              never again a barrier to innovation, negotiation, or trust."
            </p>
          </div>
        </main>
