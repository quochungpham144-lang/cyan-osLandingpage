      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        ...
        <main className="bg-gray-900/80 border border-gray-800 rounded-2xl shadow-xl px-6 py-6 md:px-8 md:py-8">
          <div className="flex items-start justify-between gap-4 border-b border-gray-800 pb-4 mb-6">
            <div>
              <div className="text-base md:text-lg font-semibold text-white">PRIVACY POLICY: CYAN OS<span className="tm-symbol">™</span> REAL-TIME TRANSLATOR</div>
          ...
          <div className="space-y-5 text-sm leading-relaxed">
            <div>
              ...
              <p className="mt-1 text-gray-300">
                Given the real-time nature of CYAN OS<span className="tm-symbol">™</span>&apos;s translation services, we adhere to the highest security standards. CYANOS<span className="tm-symbol">™</span> and its logos are trademarks of CYAN OS, Inc., a Delaware corporation. All other trademarks, service marks, and trade names are the property of their respective owners.
              </p>
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                To deliver high-quality services, CYAN OS<span className="tm-symbol">™</span> integrates with leading AI infrastructures. By using CYAN OS<span className="tm-symbol">™</span>, you also agree to the privacy policies of these partners:
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                We utilize PayPal for payment processing. CYAN OS<span className="tm-symbol">™</span>, Inc. never accesses or stores your credit card numbers, CVV codes, or bank account information. All transactions are conducted directly on PayPal&apos;s secure infrastructure.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                Regardless of your location, CYAN OS<span className="tm-symbol">™</span>, Inc. is committed to complying with international security standards:
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                In addition to audio and translated text, CYAN OS<span className="tm-symbol">™</span>, Inc. may process limited categories of personal data necessary to operate the Service:
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                Where applicable privacy laws such as GDPR or CCPA apply, CYAN OS<span className="tm-symbol">™</span>, Inc. relies on the following legal bases:
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                Our web properties may use cookies, local storage, and similar technologies to remember your preferences, secure access to the Service, and measure product performance.
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
            ...
            <div>
              ...
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
                ...
                <li>Contact: For privacy-related questions or requests, you may contact our team directly via email at contact@cyan-os.cc.</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                CYAN OS<span className="tm-symbol">™</span>, Inc. is based in Delaware, United States, and offers services globally in multiple languages. Depending on where you live, additional data protection rights may apply on top of this Policy:
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
