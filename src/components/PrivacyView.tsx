      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        <header className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-semibold text-cyan-300">CYAN OS<span className="tm-symbol">™</span> TRANSLATOR</div>
        ...
        <main className="bg-gray-900/80 border border-gray-800 rounded-2xl shadow-xl px-6 py-6 md:px-8 md:py-8">
          <div className="flex items-start justify-between gap-4 border-b border-gray-800 pb-4 mb-6">
            <div>
              <div className="text-base md:text-lg font-semibold text-white">PRIVACY POLICY: CYAN OS<span className="tm-symbol">™</span> TRANSLATOR</div>
          ...
          <div className="space-y-5 text-sm leading-relaxed">
            <div>
              ...
              <p className="mt-1 text-gray-300">
                Given the real-time nature of CYAN OS<span className="tm-symbol">™</span>&apos;s translation services, we adhere to the highest security standards:
              </p>
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                We utilize PayPal for payment processing. CYAN OS<span className="tm-symbol">™</span> never accesses or stores your credit card numbers, CVV codes, or bank account information. All transactions are conducted directly on PayPal&apos;s secure infrastructure.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                Regardless of your location, CYAN OS<span className="tm-symbol">™</span> is committed to complying with international security standards:
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                In addition to audio and translated text, CYAN OS<span className="tm-symbol">™</span> may process limited categories of personal data necessary to operate the Service:
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                Where applicable privacy laws such as GDPR or CCPA apply, CYAN OS<span className="tm-symbol">™</span> relies on the following legal bases:
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                CYAN OS<span className="tm-symbol">™</span> is based in Vietnam and offers services globally in multiple languages. Depending on where you live,
                additional data protection rights may apply on top of this Policy:
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
                <li>California (CCPA): You have the right to opt-out of the &quot;sale&quot; of personal information (Note: CYAN OS<span className="tm-symbol">™</span> does not sell your data).</li>
                ...
                <li>Contact: For privacy-related questions or requests, you may contact our team via the support channel provided on the CYAN OS<span className="tm-symbol">™</span> website.</li>
              </ul>
            </div>
          </div>
        </main>
