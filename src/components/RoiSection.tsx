...
export const RoiSection = memo(
  ({ isVisible, showRoiSection, setRef }: Props) => (
    <section
      id="roi"
      ref={setRef("roi")}
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
            ...
            and eliminate 99% of your traditional translation overhead.
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {/* Traditional Method */}
          <div className="group relative bg-white dark:bg-gray-900/40 backdrop-blur-xl border border-gray-200/80 dark:border-slate-800/80 rounded-2xl p-8 transition-all duration-300 hover:border-red-500/30 shadow-sm hover:shadow-xs hover:shadow-red-500/5">
            ...
            <div className="space-y-6">
              {[
                {
                  label: "Voice Actor (per hour)",
                  value: "$100-300",
                  note: "Unreliable scheduling",
                },
                {
                  label: "Studio Time",
                  value: "$50-150/hr",
                ...
                <div
                  key={label}
                  className="flex flex-col gap-1 border-b border-gray-100 dark:border-gray-800 pb-4 last:border-0"
                >
                  ...
                  <span className="text-[10px] text-red-400/80 font-medium uppercase tracking-tighter">
                    {note}
                  </span>
                </div>
              ))}

              <div className="bg-red-50/50 dark:bg-red-950/20 rounded-xl p-6 mt-6 border border-red-100 dark:border-red-900/30 shadow-sm">
                <div className="flex justify-between items-end">
                  <div>
                    <div className="text-xs font-bold text-red-600 dark:text-red-400 uppercase mb-1">
                      Estimated Cost
                    </div>
                    <div className="text-sm text-gray-500 dark:text-gray-400">
                      (per 10 hours of content)
                    </div>
                  </div>
          ...
          {/* CYAN-OS Method */}
          <div className="group relative bg-white dark:bg-gray-900/40 backdrop-blur-xl border-2 border-cyan-500/50 dark:border-cyan-400/40 rounded-2xl p-8 transition-all duration-300 shadow-sm hover:shadow-xs hover:shadow-cyan-500/20 overflow-hidden">
              ...
              {[
                {
                  ...
                  value: "$0.10",
                  note: "Infinite scalability",
                },
                {
                  label: "Setup Time",
                  value: "5 minutes",
                  note: "Instant integration",
                },
                {
                  label: "Processing Time",
                  value: "Real-time",
                  note: "Ultra-low latency",
                },
                ...
                >
                  ...
                  <span className="text-[10px] text-cyan-500/80 font-bold uppercase tracking-tighter">
                    {note}
                  </span>
                </div>
              ))}

              <div className="bg-cyan-500 dark:bg-cyan-500 rounded-2xl p-6 mt-6 shadow-xs shadow-cyan-500/30">
                <div className="flex justify-between items-end">
                  <div>
                    <div className="text-xs font-bold text-cyan-100 uppercase mb-1">
                      Optimized Cost
                    </div>
