          ...
          <div className="space-y-5 text-sm leading-relaxed">
            <div>
              ...
              <p className="mt-1 text-gray-300">
                CYAN OS<span className="tm-symbol">™</span> (the &quot;Company&quot;) recognizes that a person&apos;s voice is a core part of their
              ...
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
                ...
                <li>
                  CYAN OS<span className="tm-symbol">™</span>’s Role: CYAN OS<span className="tm-symbol">™</span> acts strictly as a Service Provider and a neutral processing platform. We do not
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                CYAN OS<span className="tm-symbol">™</span> maintains a Zero-Tolerance Policy regarding the following activities:
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
                <li>
            ...
            <div>
              ...
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
                ...
                <li>
                  Legal Cooperation: CYAN OS<span className="tm-symbol">™</span> will cooperate fully with law enforcement agencies in any investigation
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                The User agrees to indemnify, defend, and hold harmless CYAN OS<span className="tm-symbol">™</span>, its founders, and its technology
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                If CYAN OS<span className="tm-symbol">™</span> reasonably suspects that the voice cloning capabilities of the Service are being misused,
              ...
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
                ...
                <li>Outcome: Following investigation, CYAN OS<span className="tm-symbol">™</span> may restore access, impose additional restrictions, or permanently terminate the account in line with this Policy and applicable law.</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
                ...
                <li>Policy Updates: CYAN OS<span className="tm-symbol">™</span> may update this Policy periodically to reflect evolving legal, ethical, and technological standards in synthetic media and voice AI.</li>
              </ul>
            </div>
          </div>
        </main>
