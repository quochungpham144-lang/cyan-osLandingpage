      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        <header className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-semibold text-cyan-300">CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span></div>
          ...
          <div className="flex items-start justify-between gap-4 border-b border-gray-800 pb-4 mb-6">
            <div>
              <div className="text-base md:text-lg font-semibold text-white">
                CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span>: DEDICATED VOICE COPYRIGHT &amp; CLONING POLICY
              </div>
          ...
          <div className="space-y-5 text-sm leading-relaxed">
            <div>
              ...
              <p className="mt-1 text-gray-300">
                CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> (the &quot;Company&quot;) recognizes that a person&apos;s voice is a core part of their
              ...
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
                ...
                <li>
                  CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span>’s Role: CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> acts strictly as a Service Provider and a neutral processing platform. We do not
            ...
            <div>
              ...
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
                ...
                <li>
                  Verification Rights: CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> reserves the right, at its sole discretion, to request proof of consent or
            ...
            <div>
              ...
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
                ...
                <li>
                  Model Training Data: CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> does not use User-provided voice samples to train its core proprietary AI
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> maintains a Zero-Tolerance Policy regarding the following activities:
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
                <li>
            ...
            <div>
              ...
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
                <li>
                  Automated Detection: CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> utilizes advanced audio watermarking and metadata tracking (in
                ...
                <li>
                  Legal Cooperation: CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> will cooperate fully with law enforcement agencies in any investigation
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                The User agrees to indemnify, defend, and hold harmless CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span>, its founders, and its technology
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> utilizes third-party AI models (e.g., ElevenLabs) for voice synthesis. While CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> implements its
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                If CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> reasonably suspects that the voice cloning capabilities of the Service are being misused,
              ...
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
                ...
                <li>Investigation: CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> may review technical logs, consult with technology partners, and request additional information from the User.</li>
                <li>Outcome: Following investigation, CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> may restore access, impose additional restrictions, or permanently terminate the account in line with this Policy and applicable law.</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                Users agree to cooperate in good faith with CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span>&apos;s efforts to prevent abuse of voice technologies.
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
                <li>Information Requests: CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> may request documentation or clarification to verify rights to a specific voice or use case.</li>
            ...
            <div>
              ...
              <p className="mt-1 text-gray-300">
                This Dedicated Voice Copyright &amp; Cloning Policy operates alongside CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span>&apos;s general Privacy
                Policy and Terms of Service.
              </p>
              <ul className="mt-2 list-disc list-inside text-gray-300 space-y-1">
                <li>Zero-Retention: Except where required for security or legal reasons, audio processed through the Service is subject to CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span>&apos;s zero-retention commitments described in the Privacy Policy.</li>
                <li>Policy Updates: CYAN<sup className="text-[0.6em] ml-0.5">OS</sup><span className="tm-symbol">™</span> may update this Policy periodically to reflect evolving legal, ethical, and technological standards in synthetic media and voice AI.</li>
              </ul>
            </div>
          </div>
        </main>
