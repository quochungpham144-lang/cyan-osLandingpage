            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
              ...
              >
                ...
                <div className="text-left leading-tight">
                  ...
                  <div className="text-[10px] text-gray-500 dark:text-gray-400 sm:block hidden uppercase tracking-wider mt-0.5">
              ...
              <div className="desktop-nav-links hidden xl:flex items-center gap-2 xl:gap-4 whitespace-nowrap">
                <a
                  ...
                  className="text-[13px] font-medium hover:text-cyan-500 dark:hover:text-cyan-400 transition-colors text-gray-600 dark:text-gray-300 px-1"
                >
                  Home
                </a>
                <a
