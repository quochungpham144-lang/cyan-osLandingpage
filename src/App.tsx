                ...
                <div className="p-2">
                    ...
                    <button
                      onClick={() => {
                        ...
                        setMobileMenuOpen(false);
                        // Scroll to pricing or show early access form
                        const pricingSection = document.getElementById('pricing');
                        if (pricingSection) {
                          pricingSection.classList.remove('hidden');
                          pricingSection.style.display = 'block';
                      ...
                      className="w-full bg-gradient-to-r from-cyan-600 to-blue-600 text-white px-3 py-2 rounded-lg font-medium text-sm hover:from-cyan-700 hover:to-blue-700 transition-all flex items-center justify-center gap-2"
                    >
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
                      </svg>
                    ...
                    {isLoggedIn && userInfo ? (
                      ...
                      <button 
                        ...
                        className="w-full bg-cyan-600 dark:bg-cyan-600 text-yellow-300 px-3 py-2 rounded-lg font-semibold text-sm hover:bg-cyan-700 dark:hover:bg-cyan-700 transition-all"
                      >
                        Login
                      </button>
                    )}
